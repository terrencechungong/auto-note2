...
let sign_up_style = { fontSize: 30, marginRight: 40, fontWeight: 600, backgroundColor: 'white', borderRadius: 20, width: '70%', textAlign: 'center', transition: 'background-color 0.3s ease-in-out', paddingBottom: 2 };

let log_in_style = { fontSize: 30, marginRight: 40, fontWeight: 600, width: '60%', textAlign: 'center', alignSelf: 'center' };
